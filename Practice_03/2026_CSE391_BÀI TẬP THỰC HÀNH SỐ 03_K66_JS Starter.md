...
JavaScript có thể thay đổi nội dung trong html
...
Hello from JavaScrip
Xin chào, mình là Tuấn, năm nay mình 20 tuổi 
> - Nếu em quên dấu `;` hoặc quên dấu `+`, điều gì xảy ra? Trình duyệt báo lỗi thế nào?
Lỗi có pháp chưa được xử lí: thiếu ) sau danh sách đối số
...
>   - Tên 
hàm: tinhDiemTrungBinh, xepLoai
>   - Tham số (parameters): 8, 7, 9, avg
>   - Thân hàm (body): Phần bên trong { }
>   - Giá trị trả về (return): Điểm TB, Xếp Loại
> - Ưu điểm của việc dùng hàm thay vì lặp lại cùng một đoạn code nhiều lần là gì?
Tránh lặp lại code, chương trình ngắn gọn, dễ sửa code, tái sử dụng code
